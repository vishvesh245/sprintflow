              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <div className="flex items-center gap-3 ml-auto">
                  <span className="text-xs text-gray-400">
                    {filteredIssues.length} of {allIssues.length} ticket{allIssues.length !== 1 ? 's' : ''}
                  </span>
                  {hasActiveFilters && (
                    <button
              ...
              {selectedIssueIds.size > 0 && (
                <div className="flex items-center gap-3 rounded-lg border border-blue-200 bg-blue-50 px-4 py-3">
                  <span className="shrink-0 text-sm font-semibold text-blue-900">
                    {selectedIssueIds.size} ticket{selectedIssueIds.size !== 1 ? 's' : ''} selected
                  </span>
              ...
              {filteredIssues.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">
                    {selectedTeamName
                      ? 'Switch to All Teams to see all items, or create tickets for this team.'
                      : 'Create tickets to start planning your sprint.'}
                  </p>
                </div>
              ) : (
                <>
