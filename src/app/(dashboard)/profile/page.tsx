        ...
        <div>
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              />
              <div>
                <p className="text-sm font-medium text-gray-900">Issue assignments</p>
                <p className="text-xs text-gray-500">Get notified when an issue is assigned to you</p>
              </div>
            </label>
            <label className="flex items-center gap-3 cursor-pointer">
              <input
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Get notified when someone comments on your issues</p>
              </div>
            </label>
          </div>
        </div>
